...
export const CORPUS: CorpusEntry[] = [
  ...
  {
    key: "purana:linga:lingodbhava",
    source: "purana",
    scripture: "Linga Purana",
    reference: "Purva Bhaga — the pillar of fire",
    title: "The pillar neither of them could measure",
    theme: "the limit of a claim to be greatest",
    summary:
      "Brahma and Vishnu argue over which of them is supreme, and a column of fire appears with no visible top or bottom. They agree to settle it by finding its ends: Vishnu digs downward as a boar, Brahma flies upward as a swan. Vishnu returns and admits he found nothing. Brahma claims he reached the top, and is caught in the lie.",
    citationUrl: LINGA,
    weight: 130,
  },
  {
  ...
  {
    key: "purana:linga:upamanyu",
    source: "purana",
    scripture: "Linga Purana",
    reference: "Uttara Bhaga — the story of Upamanyu",
    title: "The boy who asked for milk",
    theme: "asking for a small thing and being given everything",
    summary:
      "A poor child tastes milk once and cries for it afterwards. His mother, having none, gives him flour stirred in water and tells him the truth. He goes to the forest and undertakes austerity for Shiva, who grants him not a cup of milk but the ocean of it.",
    citationUrl: LINGA,
    weight: 120,
  },
  {
    key: "purana:linga:daksha-sacrifice",
    source: "purana",
    scripture: "Linga Purana",
    reference: "Purva Bhaga — Daksha's sacrifice",
    title: "The father who did not invite his daughter's husband",
    theme: "contempt inside a family, and what it costs",
    summary:
      "Daksha holds a great sacrifice and pointedly omits Shiva. His daughter Sati goes uninvited, is insulted in front of everyone, and gives up her body in the sacrificial fire. The sacrifice is destroyed. Daksha is restored to life afterwards, wearing the head of a goat.",
    citationUrl: LINGA,
    weight: 130,
  },
  {
